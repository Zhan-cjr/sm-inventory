  ...
  return (
    <div className="bg-slate-950 min-h-screen text-slate-50 relative overflow-hidden">
      ...
      <div className="relative pt-40 pb-20 lg:pt-48 lg:pb-32 overflow-hidden border-b border-white/5">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-[500px] bg-blue-600/20 rounded-full blur-[150px] pointer-events-none" />
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <motion.div 
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass-panel border-white/10 text-blue-400 text-sm font-semibold tracking-widest uppercase mb-6"
            >
            ...
            <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold text-white mb-6 sm:mb-8 leading-[1.1] tracking-tight">
              ...
              <span className="bg-gradient-to-r from-blue-400 via-red-400 to-blue-600 text-gradient drop-shadow-sm">Terbaik untuk Anda</span>
            </h1>
              ...
              <div className="container mx-auto px-4 relative z-10">
                <div className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-24`}>
                  ...
                  <div className={`w-full lg:w-1/2 ${isEven ? 'lg:order-1' : 'lg:order-2'}`}>
                    ...
                    >
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl sm:rounded-[1.5rem] flex items-center justify-center mb-6 sm:mb-8 glass-panel-dark border border-blue-500/30 text-blue-400 shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                      ...
                      <div className="p-6 rounded-2xl glass-panel-dark border border-white/5 relative overflow-hidden group">
                        ...
                        <ul className="space-y-4 relative z-10">
                          <li className="flex items-start gap-4 text-base sm:text-lg text-slate-300">
                            <div className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 shrink-0 shadow-[0_0_8px_rgba(59,130,246,0.8)]" />
                            <span>Tersedia secara eksklusif di cabang-cabang pilihan kami dengan standar kualitas tertinggi.</span>
                          </li>
                          <li className="flex items-start gap-4 text-base sm:text-lg text-slate-300">
                            <div className="mt-1.5 w-2 h-2 rounded-full bg-blue-500 shrink-0 shadow-[0_0_8px_rgba(59,130,246,0.8)]" />
                            <span>Pelayanan profesional, ramah keluarga, dan <span className="font-bold text-blue-400">berprinsip islami</span>.</span>
                          </li>
                        </ul>
                      </div>
                    </motion.div>

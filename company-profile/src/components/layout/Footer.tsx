        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-2 group mb-6">
              ...
              <span className="font-bold text-2xl text-white tracking-tight">
                Toserba <span className="text-blue-600">Selamat</span>
              </span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="hover:text-blue-600 transition-colors text-sm">Tentang Kami</Link>
              </li>
              <li>
                <Link href="/facilities" className="hover:text-blue-600 transition-colors text-sm">Fasilitas & Layanan</Link>
              </li>
              <li>
                <Link href="/locations" className="hover:text-blue-600 transition-colors text-sm">Lokasi Cabang</Link>
              </li>
              <li>
                <a href="http://shopping.toserbaselamat.id" className="hover:text-blue-600 transition-colors text-sm">
                  Belanja Online
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="text-sm hover:text-blue-600 cursor-pointer transition-colors">Supermarket & Fashion</li>
              <li className="text-sm hover:text-blue-600 cursor-pointer transition-colors">Hotel Syariah</li>
              <li className="text-sm hover:text-blue-600 cursor-pointer transition-colors">SHSC Fitness Center</li>
              <li className="text-sm hover:text-blue-600 cursor-pointer transition-colors">Padel Court</li>
              <li className="text-sm hover:text-blue-600 cursor-pointer transition-colors">Jajanan Subuh</li>
            </ul>
          </div>

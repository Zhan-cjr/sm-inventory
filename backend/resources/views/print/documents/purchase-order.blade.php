...
@section('content')
    ...
    <div class="page-container">
        ...
        <div class="document-title">
            <h1>Pesanan Pembelian (Purchase Order)</h1>
        </div>
        ...
        <table class="info-table">
            <tr>
                ...
                <td class="separator">:</td>
                <td>{{ \Carbon\Carbon::parse($doc->po_date)->format('d-m-Y') }}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">Tgl Pengiriman Est.</td>
                <td class="separator">:</td>
                <td colspan="4">{{ \Carbon\Carbon::parse($doc->expected_delivery_date)->format('d-m-Y') }}</td>
            </tr>
            @endif
        </table>
        ...
        <table class="signature-table">
            <tr>
                <td>
                    ...
                    Dibuat Oleh<br>
                    ({{ $doc->creator ? $doc->creator->name : 'Admin' }})
                </td>
                <td>
                    <div class="signature-line"></div>
                    Disetujui Oleh<br>

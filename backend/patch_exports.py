...
files = [
    ...
    "app/Filament/Pages/LaporanJasaTerjual.php",
    "app/Filament/Pages/LaporanPersediaan.php",
...
for f in files:
    ...
    # Extract the report type from the 'cetak' action's url
    ...
    # Extract the exporter class from the ExportAction
    ...
    # Using lambda to avoid escape character interpretation
